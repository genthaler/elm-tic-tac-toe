...
var $author$project$Main$Model = F2(
	function (game, maybeWindow) {
		return {game: game, maybeWindow: maybeWindow};
	});
var $elm$browser$Browser$Dom$getViewport = _Browser_withWindow(_Browser_getViewport);
var $author$project$Game$X = {$: 'X'};
var $author$project$Matrix$Matrix = function (a) {
	return {$: 'Matrix', a: a};
};
var $author$project$Matrix$makeMatrix = F3(
	function (nrows, ncols, array) {
		return $author$project$Matrix$Matrix(
			{array: array, ncols: ncols, nrows: nrows});
	});
...
var $author$project$Matrix$repeat = F3(
	function (nrows, ncols, value) {
		return A3(
			$author$project$Matrix$makeMatrix,
			nrows,
			ncols,
			A2($elm$core$Array$repeat, nrows * ncols, value));
	});
var $author$project$Game$initBoard = A3($author$project$Matrix$repeat, 3, 3, $elm$core$Maybe$Nothing);
var $author$project$Game$initGame = {board: $author$project$Game$initBoard, player: $author$project$Game$X};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$Main$Model, $author$project$Game$initGame, $elm$core$Maybe$Nothing),
		A2($elm$core$Task$perform, $author$project$Main$GetViewPort, $elm$browser$Browser$Dom$getViewport));
};
var $author$project$Main$GetResize = F2(
	function (a, b) {
		return {$: 'GetResize', a: a, b: b};
	});
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onResize($author$project$Main$GetResize);
};
...
var $author$project$Matrix$get = F3(
	function (i, j, _v0) {
		var nrows = _v0.a.nrows;
		var ncols = _v0.a.ncols;
		var array = _v0.a.array;
		return ((i < 0) || ((j < 0) || ((_Utils_cmp(i, nrows) > -1) || (_Utils_cmp(j, ncols) > -1)))) ? $elm$core$Maybe$Nothing : A2($elm$core$Array$get, (ncols * i) + j, array);
	});
...
var $author$project$Game$lines = function () {
	var r = A2($elm$core$List$range, 0, 2);
	var rows = A2(
		$elm$core$List$map,
		function (i) {
			return A2(
	...
	var columns = A2(
		...
		function (i) {
			return A2(
				$elm$core$List$map,
				A2($elm_community$basics_extra$Basics$Extra$flip, $elm$core$Tuple$pair, i),
				r);
		},
		r);
	return _Utils_ap(
		rows,
		_Utils_ap(columns, diagonals));
}();
var $author$project$Game$O = {$: 'O'};
var $author$project$Game$updatePlayer = function (currentPlayer) {
	if (currentPlayer.$ === 'X') {
		return $author$project$Game$O;
	} else {
		return $author$project$Game$X;
	}
};
var $author$project$Game$scoreGame = function (game) {
	var getPlayer = function (_v1) {
		var i = _v1.a;
		var j = _v1.b;
		return $elm_community$maybe_extra$Maybe$Extra$join(
			A3($author$project$Matrix$get, i, j, game.board));
	};
	var linesWithPlayers = A2(
		$elm$core$List$map,
		$elm$core$List$map(
			function (ij) {
				return _Utils_Tuple2(
		...
		$author$project$Game$lines);
	var enemy = $author$project$Game$updatePlayer(game.player);
	var noEnemyHere = function (_v0) {
		var maybePlayer = _v0.b;
		return !_Utils_eq(
			maybePlayer,
			$elm$core$Maybe$Just(enemy));
	};
	var availableLinesWithPlayers = A2(
		$elm$core$List$filter,
		A2(
			$elm$core$List$foldl,
			A2($elm$core$Basics$composeR, noEnemyHere, $elm$core$Basics$and),
			true),
		linesWithPlayers);
	return A2(
		$elm$core$Dict$map,
...
var $author$project$Game$getWinningPositions = A2(
	$elm$core$Basics$composeR,
	$author$project$Game$scoreGame,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$Dict$get(3),
		A2(
			...
			A2($elm$core$Basics$composeR, $elm$core$List$concat, $elm_community$list_extra$List$Extra$unique))));
var $author$project$Matrix$mapArray = F2(
	function (f, _v0) {
		var nrows = _v0.a.nrows;
		var ncols = _v0.a.ncols;
		var array = _v0.a.array;
...
var $author$project$Matrix$to2d = F4(
	function (f, ncols, i, j) {
		return f((i * ncols) + j);
	});
var $author$project$Matrix$set = F4(
	function (i, j, a, m) {
		var nrows = m.a.nrows;
		var ncols = m.a.ncols;
		return ((i < 0) || ((j < 0) || ((_Utils_cmp(i, nrows) > -1) || (_Utils_cmp(j, ncols) > -1)))) ? m : A2(
			$author$project$Matrix$mapArray,
			A5($author$project$Matrix$to2d, $elm$core$Array$set, ncols, i, j, a),
			m);
	});
		...
		var game_ = _Utils_update(
			game,
			{
				board: A4(
					...
					x,
					y,
					$elm$core$Maybe$Just(game.player),
					game.board)
			});
		return $elm$core$List$isEmpty(
			$author$project$Game$getWinningPositions(game_)) ? _Utils_update(
			game_,
			{
				player: $author$project$Game$updatePlayer(game_.player)
			}) : game_;
	});
			...
			case 'Click':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							game: A3($author$project$Game$updateGame, x, y, model.game)
						}),
					$elm$core$Platform$Cmd$none);
			case 'GetViewPort':
				var viewport = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							maybeWindow: $elm$core$Maybe$Just(
								_Utils_Tuple2(
									$elm$core$Basics$round(viewport.scene.width),
									$elm$core$Basics$round(viewport.scene.height)))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var x = msg.a;
...
var $author$project$Matrix$from2d = F3(
	function (f, ncols, i) {
		return A2(f, (i / ncols) | 0, i % ncols);
	});
...
var $author$project$Matrix$width = function (_v0) {
	var ncols = _v0.a.ncols;
	return ncols;
};
	...
	function (f, m) {
		return A2(
			...
			$elm$core$Array$indexedMap(
				A2(
					$author$project$Matrix$from2d,
					f,
					$author$project$Matrix$width(m))),
			m);
	});
...
var $author$project$Matrix$height = function (_v0) {
	var nrows = _v0.a.nrows;
	return nrows;
};
var $author$project$Matrix$toArray = function (_v0) {
	var array = _v0.a.array;
	return array;
};
var $author$project$Matrix$toArrays = function (m) {
	var slice = function (i) {
		return A3(
			$elm$core$Array$slice,
			i * $author$project$Matrix$width(m),
			(i + 1) * $author$project$Matrix$width(m),
			$author$project$Matrix$toArray(m));
	};
	return A2(
		$elm$core$Array$initialize,
		$author$project$Matrix$height(m),
		slice);
};
var $author$project$Matrix$toLists = A2(
	$elm$core$Basics$composeR,
	$author$project$Matrix$toArrays,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Main$viewCell = F4(
	function (winningPositions, x, y, cell) {
		var handler = function () {
			if ($elm$core$List$isEmpty(winningPositions)) {
				if (cell.$ === 'Nothing') {
					return $elm$core$Maybe$Just(
		...
		var fontColor = A2(
			...
			_Utils_Tuple2(x, y),
			winningPositions) ? A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255) : A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0);
		var cellContent = function () {
			if (cell.$ === 'Just') {
				var player = cell.a;
				return $author$project$Main$viewPlayer(player);
			} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{
						blur: 1.0,
						color: A3($mdgriffith$elm_ui$Element$rgb255, 150, 150, 150),
						offset: _Utils_Tuple2(4.0, 4.0),
						size: 3
					})
				]),
			{
				label: A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Font$size(128),
...
var $author$project$Main$view = function (_v0) {
	var game = _v0.game;
	var maybeWindow = _v0.maybeWindow;
	var winningPositions = $author$project$Game$getWinningPositions(game);
	var viewBoard = A2(
		...
		A2(
			...
			$author$project$Matrix$toLists),
		$author$project$Matrix$indexedMap(
			$author$project$Main$viewCell(winningPositions)));
	var gameOver = !$elm$core$List$isEmpty(winningPositions);
	var headline = gameOver ? 'Winner, Player ' : 'Ready, Player ';
	var viewHeader = F2(
		function (_v1, player) {
			var height = _v1.a;
			var width = _v1.b;
				...
				A2(
					...
					_List_fromArray(
						[
							...
							((A2($elm$core$Basics$min, height, width) * 64) / 1000) | 0)
						]),
					_List_fromArray(
						[
	...
	var viewWindow = function (window) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2(viewHeader, window, game.player),
	...
	return A2(
		...
		A2(
			...
			A2($elm$core$Maybe$map, viewWindow, maybeWindow)));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Click":["Basics.Int","Basics.Int"],"GetViewPort":["Browser.Dom.Viewport"],"GetResize":["Basics.Int","Basics.Int"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});
...
//# sourceMappingURL=/elm-tic-tac-toe.e31bb0bc.js.map